...
/**
 * Copied from hadoop-aws since it was needed in hadoop-hdfs-project/hadoop-hdfs
 * and adding hadoop-aws as a dependency would have created a circular dependency.
 *
