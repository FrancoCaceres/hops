...
public class DFSConfigKeys extends CommonConfigurationKeys {
  ...
  public static final int DFS_CLIENT_OBJECT_STORAGE_PART_SIZE_DEFAULT = 12*1024*1024;
  public static final String DFS_CLIENT_OBJECT_STORAGE_MAX_CONNECTIONS_KEY = "dfs.client.object-storage.max-connections";
  public static final int DFS_CLIENT_OBJECT_STORAGE_MAX_CONNECTIONS_DEFAULT = 50;
  public static final String DFS_CLIENT_OBJECT_STORAGE_MAX_THREADS_KEY = "dfs.client.object-storage.max-threads";
  public static final int DFS_CLIENT_OBJECT_STORAGE_MAX_THREADS_DEFAULT = 100;
  public static final String DFS_CLIENT_OBJECT_STORAGE_MAX_TASKS_KEY = "dfs.client.object-storage.max-tasks";
  public static final int DFS_CLIENT_OBJECT_STORAGE_MAX_TASKS_DEFAULT = 5;
  public static final String DFS_CLIENT_OBJECT_STORAGE_KEEP_ALIVE_KEY = "dfs.client.object-storage.keep-alive";
  public static final int DFS_CLIENT_OBJECT_STORAGE_KEEP_ALIVE_DEFAULT = 60;
  public static final String DFS_CLIENT_OBJECT_STORAGE_IS_BUFFER_ENABLED_KEY = "dfs.client.object-storage.is-buffer.enabled";
  public static final boolean DFS_CLIENT_OBJECT_STORAGE_IS_BUFFER_ENABLED_DEFAULT = false;
  public static final String DFS_CLIENT_OBJECT_STORAGE_IS_BUFFER_SIZE_KEY = "dfs.client.object-storage.is-buffer.size";
  public static final int DFS_CLIENT_OBJECT_STORAGE_IS_BUFFER_SIZE_DEFAULT = 104857600;
  public static final String DFS_NAMENODE_OBJECT_STORAGE_S3_CRC32_ENABLED_KEY = "dfs.namenode.object-storage.s3.crc32.enabled";
  public static final boolean DFS_NAMENODE_OBJECT_STORAGE_S3_CRC32_ENABLED_DEFAULT = false;
