...
public class IDsMonitor implements Runnable {
  ...
  public void setConfiguration(Configuration conf) {
    IDsGeneratorFactory.getInstance().setConfiguration(
      conf.getInt(DFSConfigKeys.DFS_NAMENODE_INODEID_BATCH_SIZE, DFSConfigKeys.DFS_NAMENODE_INODEID_BATCH_SIZE_DEFAULT),
      conf.getInt(DFSConfigKeys.DFS_NAMENODE_BLOCKID_BATCH_SIZE, DFSConfigKeys.DFS_NAMENODE_BLOCKID_BATCH_SIZE_DEFAULT),
      conf.getInt(DFSConfigKeys.DFS_NAMENODE_S3OBJECTID_BATCH_SIZE, DFSConfigKeys.DFS_NAMENODE_S3OBJECTID_BATCH_SIZE_DEFAULT),
      ...
      conf.getInt(DFSConfigKeys.DFS_NAMENODE_CACHE_DIRECTIVE_ID_BATCH_SIZE, DFSConfigKeys.DFS_NAMENODE_CACHE_DIRECTIVE_ID_BATCH_SIZE_DEFAULT),
      ...
      conf.getFloat(DFSConfigKeys.DFS_NAMENODE_S3OBJECTID_UPDATE_THRESHOLD, DFSConfigKeys.DFS_NAMENODE_S3OBJECTID_UPDATE_THRESHOLD_DEFAULT),
      ...
      conf.getFloat(DFSConfigKeys.DFS_NAMENODE_CACHE_DIRECTIVE_ID_UPDATE_THRESHOLD, DFSConfigKeys.DFS_NAMENODE_CACHE_DIRECTIVE_ID_UPDATE_THRESHOLD_DEFAULT)
    );
